  ...
  return (
    <PlacePage
      ...
      experiences={[
        ...
        { title: "Night Sky Astronomy", desc: "The park's vast dark skies offer some of the finest stargazing in India. Guided night sessions with telescopes are available through Jaiscape's partners.", tag: "Astronomy" },
      ...
      travelInfo={{
        ...
        distance: "40km from Jaisalmer via Sam village. Jeep required — arrange through your hotel or Jaiscape.",
