...
export default function VideoTemplate({
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden bg-bg-dark">
      ...
      <motion.div
        className="absolute h-[1px] bg-primary/30 pointer-events-none"
        animate={{
      ...
      {/* Frame border */}
      <div className="absolute inset-4 border border-white/5 rounded-2xl pointer-events-none z-50"></div>
